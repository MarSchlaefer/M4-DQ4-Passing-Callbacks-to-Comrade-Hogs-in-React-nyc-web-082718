...
export default class PigPen extends React.Component {
  ...
  render() {
    ...
    return(
      <div id="pig-pen">
        {sheeple}
        <GalaxySNote7 environment={this.state.environment} alterEnvironment={null} setEnvironment={this.alterEnvironment} relax={this.relax}/>
      </div>
    )
  }
}
